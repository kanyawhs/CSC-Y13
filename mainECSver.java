...
public class mainECSver
{
    ...
    public void doMouse(String action, double x, double y) {
        switch (action) {
            ...
            case "released" -> {
                    this.releasedX = x;
                    this.releasedY = y;
                    // bounds are slightly off??
                    if (active && releasedX >=oQueueX+140 && releasedX <= oQueueX+240 && releasedY >= oQueueY && releasedY <= oQueueY+100 && !oQueue.orderQueueEmpty() && wQueue.waitingQueueEmpty()) {
                        ...
                        if (!wQueue.waitingQueueEmpty()) {
                            ...
                            // use if statements for recieving method
    ...
    public String chop (String recipe) {
        /*placeholder*/
        UI.println("Chopping...");
        UI.sleep(5000);
        return("chop");
    ...
    public String mix (String recipe) {
        /*placeholder*/
        UI.println("Mixing...");
        UI.sleep(5000);
        return("mix");
    ...
    public String oven (String recipe) {
        /*placeholder*/
        UI.println("Baking...");
        UI.sleep(5000);
        return("oven");
    ...
    public String refridgerate (String recipe) {
        /*placeholder*/
    ...
    public String decorate (String recipe) {
        /*placeholder*/
